                ...
                showReply && (
                    <TouchableOpacity style={styles.replyView} onPress={() => setShowReply(false)}>
                        <Animated.View style={[styles.animatedBox, styles.imgStyle, animatedStyle]}>
                            <Animated.Image style={styles.imgStyle} source={require('../images/up-arrow.png')} />
                        </Animated.View>
                ...
                !showReply && (
                    <View style={styles.innerDiv}>
                        <TouchableOpacity style={styles.imgStyle} onPress={() => onReplyButtonClick && onReplyButtonClick('smiley', progressIndex)}>
                            <Image style={styles.imgStyle} source={require('../images/smiley.png')} />
                        </TouchableOpacity>
                        <TextInput
                            autoFocus
                            numberOfLines={5}
                        ...
                        <TouchableOpacity style={styles.imgStyle} onPress={() => onReplyButtonClick && onReplyButtonClick('send', progressIndex)}>
                            <Image style={styles.imgStyle} source={require('../images/send.png')} />
                        </TouchableOpacity>
                    </View>
                )
            }
